...
const ROUTE_TITLES: Record<string, { key: string; ns?: string } | string> = {
  ...
  '/startup': { key: 'startup' },
  '/disk': { key: 'diskAnalyzer' },
  '/duplicates': { key: 'duplicateFinder' },
  '/large-files': { key: 'largeFileFinder' },
  '/empty-folders': { key: 'emptyFolderCleaner' },
  '/file-shredder': { key: 'fileShredder' },
  '/disk-repair': { key: 'diskRepair' },
  '/disk-maintenance': { key: 'diskMaintenance' },
  '/network': { key: 'network' },
  '/hosts-editor': { key: 'hostsEditor' },
  '/malware': { key: 'malwareScanner' },
  '/game-mode': { key: 'gameMode' },
  '/windows-tweaks': { key: 'windowsTweaks' },
  ...
  '/about': { key: 'aboutUpdates' },
  '/privacy': { key: 'privacy' },
  '/services': { key: 'services' },
  '/compliance': { key: 'compliance' },
  '/vulnerability': { key: 'vulnerability' },
  '/firewall': { key: 'firewallAudit' },
  '/power-plans': { key: 'powerPlans' },
  '/debloater': { key: 'bloatwareRemover' },
  '/updates': { key: 'softwareUpdates' },
  '/installer': { key: 'appInstaller' },
  '/activation': { key: 'activation' },
  '/schedules': { key: 'schedules' },
  '/drivers': { key: 'driverUpdates' },
}
