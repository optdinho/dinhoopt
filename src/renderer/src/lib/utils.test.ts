...
describe('cn', () => {
  ...
  it('filters falsy values', () => {
    expect(cn('base', false && 'hidden', undefined, null, 'visible')).toContain('base')
    expect(cn('base', false && 'hidden', undefined, null, 'visible')).toContain('visible')
    expect(cn('base', false && 'hidden', undefined, null, 'visible')).not.toContain('hidden')
  })
})
