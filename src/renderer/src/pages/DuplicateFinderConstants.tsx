...
interface SettingsPanelProps {
  ...
  activeExtPreset: string | null
  t: (key: string) => string
}

export function SettingsPanel({ store, excludeInput, setExcludeInput, activeExtPreset, t }: SettingsPanelProps) {
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => store.setMaxDepth(Math.max(1, Math.min(50, Number.parseInt(e.target.value, 10) || 20)))}
